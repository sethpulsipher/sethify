    ...
    <Section className="bg-white dark:bg-ink-light py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <motion.div 
            className="group relative bg-card text-card-foreground p-8 sm:p-12 shadow-sm dark:shadow-none hover:shadow-xl hover:shadow-coral/5 transition-all duration-300 border border-border/50 overflow-hidden"
          >
            {/* <div className="absolute inset-0 bg-gradient-to-br from-coral/5 to-transparent opacity-0 group-hover:opacity-50 transition-opacity duration-300" /> */}
            
            <div className="relative z-10 flex flex-col h-full">
              <div className="w-16 h-16 bg-cream text-coral flex items-center justify-center mb-8 shadow-sm group-hover:scale-110 transition-transform duration-300">
              ...
              <Link href="/web-design/" className="inline-flex items-center text-coral font-semibold hover:text-coral-dark transition-colors group/link mt-auto">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="w-16 h-16 bg-cream-dark text-coral flex items-center justify-center mb-8 shadow-sm group-hover:scale-110 transition-transform duration-300">
              ...
              <Link href="/ai-systems/" className="inline-flex items-center text-coral-dark font-semibold hover:text-coral-dark transition-colors group/link mt-auto">
                Explore Automation 
                <ArrowRight className="ml-2 w-5 h-5 transform group-hover/link:translate-x-1 transition-transform" />
              </Link>
            </div>
